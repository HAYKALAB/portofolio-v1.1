    ...
    >
      ...
      <div className="max-w-[1160px] mx-auto relative z-10">
        ...
        >
          ...
          <span className="text-[11px] font-mono tracking-[0.2em] text-slate-400">{t.projects.label}</span>
        ...
        <div className="mt-6 max-w-[720px]">
          ...
          >
            ...
            <span className="bg-gradient-to-r from-white via-sky-100 to-slate-400 bg-clip-text text-transparent">{" "}{t.projects.titleHighlight}</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-0">
            ...
            <div className="relative bg-[#0B1220] p-4 sm:p-5">
              ...
              <div className="flex items-center justify-between rounded-t-[16px] border border-white/10 bg-[#070B14] px-3 py-2.5">
                ...
                <span className="hidden sm:inline-flex items-center gap-1.5 text-[10px] font-mono text-emerald-300">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" /> {t.projects.liveBadge}
                </span>
              </div>
              ...
              <div className="rounded-b-[16px] border-x border-b border-white/10 bg-gradient-to-b from-[#0B1220] to-[#070B14] p-4 sm:p-5">
                <div className="flex items-center justify-between gap-3">
                  <h3 className="text-sm font-semibold text-white">{t.projects.mockupTitle}</h3>
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-amber-300/20 bg-amber-400/10 px-2.5 py-1 text-[10px] font-semibold tracking-wide text-amber-200">
                    <Hammer size={11} /> {t.projects.inProgress}
                  </span>
                </div>
                <p className="mt-1.5 text-xs leading-relaxed text-slate-400">
                  {t.projects.mockupDesc}
                </p>

                {/* mini stats */}
                <div className="mt-4 grid grid-cols-3 gap-2">
                  {[
                    { icon: MapPinned, k: "6", v: t.projects.statLocations },
                    { icon: CalendarCheck, k: "3", v: t.projects.statStatus },
                    { icon: Heart, k: "fav", v: t.projects.statFav },
                  ].map((it) => (
                ...
                <div className="mt-4 grid grid-cols-2 gap-2">
                  ...
                  <div className="rounded-xl border border-white/10 bg-[#0B1220] p-3">
                    ...
                    <div className="mt-3 h-6 rounded-full bg-white text-[10px] font-semibold text-black grid place-items-center">{t.projects.addLocation}</div>
                  </div>
                </div>

                <div className="mt-4 flex items-center gap-2 text-[11px] font-mono text-slate-500">
                  <Clock3 size={11} /> {t.projects.lastUpdate}
                </div>
              </div>
            ...
            <div className="p-6 sm:p-7 flex flex-col">
              <div className="inline-flex items-center gap-2 text-[11px] font-mono tracking-[0.16em] text-amber-200">
                <span className="h-1.5 w-1.5 rounded-full bg-amber-400 animate-pulse" /> {t.projects.stillBuilding}
              </div>

              <h3 className="mt-3 text-[22px] font-display font-bold tracking-tight text-white leading-none">
                FUTSALIN
                <span className="font-normal text-slate-400">{t.projects.tagline}</span>
              </h3>
              ...
              <div className="mt-5 flex flex-wrap gap-1.5">
                {["Next.js 16", "TypeScript", "Tailwind", "NestJS", "PostgreSQL", "TypeORM", "Framer Motion"].map((tech) => (
                  <span key={tech} className="rounded-full bg-white px-2.5 py-1 text-[11px] font-semibold text-black">
                    {tech}
                  </span>
                ))}
              </div>
              ...
              <div className="mt-6 grid grid-cols-1 gap-2 text-xs">
                <div className="flex gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-3 py-2.5">
                  ...
                  <span className="text-slate-300">{t.projects.features[0]}</span>
                </div>
                <div className="flex gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-3 py-2.5">
                  <span className="text-sky-300">—</span>
                  <span className="text-slate-300">{t.projects.features[1]}</span>
                </div>
                <div className="flex gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-3 py-2.5">
                  <span className="text-sky-300">—</span>
                  <span className="text-slate-300">{t.projects.features[2]}</span>
                </div>
              </div>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-2.5">
                ...
                >
                  <SiGithub size={16} /> {t.projects.github} <ArrowUpRight size={14} />
                </a>
